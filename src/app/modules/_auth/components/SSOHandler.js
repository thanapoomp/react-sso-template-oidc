      ...
      .then((user) => {
        if (user) {
          ...
          let payload = {
            ...
            permission: authCRUD.getPermissions(user.id_token),
            // roles: user.profile.role ? user.profile.role : [], //TODO: get roles
            // permission: user.profile.permission ? user.profile.permission : [], //TODO: get permission
          };
          setLoggedIn(true);
